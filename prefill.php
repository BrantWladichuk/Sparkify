...
$replacements = [
    'BrantWladichuk\\\\Sparkify\\\\' => function () use(&$values) { return str_replace('\\', '\\\\', $values['psr4_namespace']) . '\\\\'; },
    ...
    'BrantWladichuk'                      => function () use(&$values) { return $values['package_vendor']; },
    'Sparkify'                => function () use(&$values) { return $values['package_name']; },
